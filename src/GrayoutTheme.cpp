#include "GrayoutTheme.h"

void ofxImGui::GrayoutTheme::setup()
{
	...
	colors[ImGuiCol_CheckMark] = ImVec4(0.90f, 0.70f, 0.00f, 0.50f);
	colors[ImGuiCol_SliderGrab] = ImVec4(0.56f, 0.56f, 0.56f, 0.40f);
	colors[ImGuiCol_SliderGrabActive] = ImVec4(0.90f, 0.70f, 0.00f, 0.70f);
	...
	colors[ImGuiCol_Separator] = ImVec4(0.90f, 0.70f, 0.00f, 0.50f);
	...
	colors[ImGuiCol_PlotHistogram] = ImVec4(0.90f, 0.70f, 0.00f, 0.70f);
